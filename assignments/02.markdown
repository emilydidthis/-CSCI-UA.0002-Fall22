...
Write a program that calculates the minimum score you need to receive on the final exam to receive each corresponding final letter grade. Ensure that your output matches the sample output as closely as possible.
<br>
...
Here are the scores you need to receive on the final
to receive the following letter grades:
